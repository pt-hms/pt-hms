...
export default function Page() {
  ...
  // Konversi data backend menjadi format yang sesuai
  const processedData = data.map((item) => ({
    tanggal: dayjs(item.date).format("YYYY-MM-DD"), // ambil tanggal saja
    jumlah: item.count ?? 1, // jika backend belum ada jumlah, default 1
  }));
