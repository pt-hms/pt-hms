...
export default function page() {
  ...
  return (
    <div className="w-full flex items-center justify-center min-h-screen pb-[62px]">
      <div className="mx-auto w-fit h-full px-8 flex flex-col items-center justify-center gap-6 bg-[#bdbec3]shadow-md pt-[62px] pb-[62px]">
        <div className="w-[240px] h-[240px] relative">
          <Image src={"/profil.jpeg"} alt="Foto Profil Driver" fill={true} className="border-2 border-[#e10b16] object-top object-cover rounded-full" objectFit="cover" />
        </div>
