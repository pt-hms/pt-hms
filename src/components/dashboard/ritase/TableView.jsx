  ...
  return (
    <>
      ...
      <Box className="w-full bg-white shadow-sm rounded-xl overflow-x-auto border border-gray-100">
          ...
          <Table.Tbody>
            {paginatedData.map((row, i) => (
              ...
              >
                ...
                <Table.Td>
                  <Badge color={row.type === "PREMIUM" ? "yellow" : "gray"}>
                    {row.type}
                  </Badge>
                </Table.Td>
        ...
        {/* ✅ Detail Panel */}
        {selectedRow && (
          <Box className="p-4 border-t border-gray-200 bg-gray-50 flex flex-col sm:flex-row items-center justify-between gap-3">
